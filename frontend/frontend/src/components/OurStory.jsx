...
function NeuralNetworkVisual() {
    ...
    return (
        ...
        <div
            className="how-visual neural-visual"
            aria-hidden="true"
        >
...
function ScatterVisual() {
    ...
    return (
        ...
        <div
            className="how-visual scatter-visual"
            aria-hidden="true"
        >
...
function CompetitionVisual() {
    ...
    return (
        ...
        <div
            className="how-visual competition-visual"
            aria-hidden="true"
        >
...
function OurStory() {
    ...
    const [storyVisible, setStoryVisible] =
        useState(false);
    ...
    return (
        ...
        >
            ...
            <div
                className="how-orb how-orb-one"
                aria-hidden="true"
            ></div>


            <div
                className="how-orb how-orb-two"
                aria-hidden="true"
            ></div>
            ...
            <span
                className="how-particle hp-1"
                aria-hidden="true"
            ></span>

            <span
                className="how-particle hp-2"
                aria-hidden="true"
            ></span>

            <span
                className="how-particle hp-3"
                aria-hidden="true"
            ></span>

            <span
                className="how-particle hp-4"
                aria-hidden="true"
            ></span>

            <span
                className="how-particle hp-5"
                aria-hidden="true"
            ></span>
            ...
            <div className="how-container">
                ...
                <header className="how-header">
                    ...
                    <p>
                        ...
                        Learn the concepts,
                        turn them into working
                        models, then put your
                        ideas to the test.
                ...
                <div className="how-cards">
                    ...
                    >
                        ...
                        <div className="card-topline">
                            ...
                            <span className="card-symbol mint">
                                ✦
                            </span>
